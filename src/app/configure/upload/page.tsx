...
const Page = () => {
  ...
  const onDropRejected = (rejectedFiles: FileRejection[]) => {
    ...
    toast({
      ...
      description: "Please use png, jpg or jpeg image instead.",
      variant: "destructive",
    });
  };
        ...
        >
          {({ getRootProps, getInputProps }) => (
            ...
            >
              <input {...getInputProps()} />
              {isDragOver ? (
                <MousePointerSquareDashed className="h-6 w-6 text-zonc-500 mb-2" />
              ...
              {isPending ? null : <p className="text-xs text-zinc-500">PN</p>}
            </div>
          )}
        </Dropzone>
      </div>
